...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">View Submissions - <?php echo htmlspecialchars($assessment['title']); ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="Dashboard.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="Assessment_View.php">View Assessments</a></li>
...
<script>
    function submitGrade(submissionId) {
        ...
        xhr.open("POST", "Assessment_Grade.php", true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xhr.onreadystatechange = function() {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    // Grade submitted successfully
                    // Reload the page to reflect changes and show session message
                    location.reload();
                } else {
                    // Error handling
        ...
        xhr.send("submission_id=" + submissionId + "&grade=" + grade);
    }
</script>
